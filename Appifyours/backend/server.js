...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/mohan_shop_app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '69c4e21fed334f3809e3df0b',
...
app.listen(PORT, () => {
  ...
  console.log(`mohan_shop Backend Server running on port ${PORT}`);
